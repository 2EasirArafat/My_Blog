	...
	<div class="row" id="content">
		<div class="col-lg-offset-3 col-lg-6">
			...
			<form action="../post" method="POST" role="form" style="background-color: white; padding: 50px">
				...
				<legend><h1>Add Your Post</h1></legend>
			
				<div class="form-group{{ $errors->has('postHeading') ? ' has-error' : '' }}">
					<label for="post-heading">Heading</label>

					<input type="text" class="form-control" id="post-heading" name="postHeading" placeholder="Enter the post Heading" value="{{ old('postHeading') }}">
				...
				<div class="form-group">
					<label for="postCatagory">Catagory</label>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="form-group">
					<label for="post-catagory">Status</label><br>
